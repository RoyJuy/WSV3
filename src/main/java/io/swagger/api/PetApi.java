...
public interface PetApi {
    ...
    ResponseEntity<Void> addPet(@ApiParam(value = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestParam(value = "addPet") String action1, @RequestParam String userToken, @RequestHeader("Accept") String accept);
    ...
    ResponseEntity<Void> deletePet(@ApiParam(value = "Pet id to delete",required=true ) @RequestParam(value = "deletePet") String action1,  @RequestParam int petId, @RequestParam String userToken,@ApiParam(value = "" ) @RequestHeader(value="api_key", required=false) String apiKey, @RequestHeader("Accept") String accept);
    ...
    ResponseEntity<List<Pet>> findPetsByStatus( @NotNull@ApiParam(value = "Status values that need to be considered for filter", required = true, allowableValues = "available, pending, sold") @RequestParam(value = "getPetItem", required = true) String action1,@RequestParam(required = false) String userToken,@RequestParam int petId, @RequestHeader("Accept") String accept) throws IOException;

    @ApiOperation(value = "get pet status", notes = "", response = void.class, authorizations = {
            @Authorization(value = "petstore_auth", scopes = {
    ...
    @RequestMapping(value = "/pet/{action1}",
    produces = {"application/xml","application/json"},
    method = RequestMethod.GET)
    ResponseEntity<Void> getPetType( @NotNull @ApiParam(value = "", required = true) @PathVariable(value = "getPetTypeList") String action1);
